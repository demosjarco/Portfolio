...
class CSPGenerator {
	...
	private setupCSP() {
		...
		this.addScript({ self: true, unsafeInline: true, unsafeEval: true, domains: [new URL('https://static.cloudflareinsights.com').origin, new URL('https://ajax.cloudflare.com').origin], nonce: true });
