/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1aa4dbad0ddd50cd1e9db57ceeb7f628)
// Runtime types generated with workerd@1.20260617.1 2026-05-26 enable_request_signal,global_fetch_strictly_public,nodejs_compat,request_signal_passthrough
interface __BaseEnv_Env {
	...
	CHATROOM: DurableObjectNamespace<import('./src/entry.cloudflare-workers').Chatroom>;
	UPDATE_WAF: Workflow<Parameters<import('./src/entry.cloudflare-workers').UpdateWaf['run']>[0]['payload']>;
	CLEANUP: Workflow<Parameters<import('./src/entry.cloudflare-workers').Cleanup['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'NODE_ENV' | 'SQL_TTL' | 'CF_API_TOKEN' | 'TURNSTILE_SECRET_KEY'>> {}
}
